                            ...
                            <AnimatePresence>
                                {showNotifs && (
                                    <motion.div
                                        ...
                                        className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 origin-top-right ring-1 ring-black ring-opacity-5"
                                    >
